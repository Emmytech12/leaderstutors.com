...
<?php if ($page=='dashboard'){?>
        <div class="statistics-back-div">
            <div class="statistics-div bg1" id="admin" onclick="handleAdminClick()">
                <div class="inner-div">                    
                    Administrator <br>
...
<?php if ($page=='system_alert'){ ?> 
    <div class="search-div">
        <!--------------------------------all search select------------------------->
        <input id="search_keywords" onkeyup="_fetch_system_alert();" type="text" class="text_field utext full" placeholder="Type here to search..." title="Type here to search" />
    </div>

    <div class="chart-back-div ntf-chart-back-div">
        <div class="chart-div-notifications">
            <div class="text"><i class="bi-graph-up-arrow"></i> Showing Matrix for</div> 
    ...
    <div class="alert alert-success not-alert"> <span><i class="bi-bell"></i></span> Notification Between  <span>February 12 2024 - March 13 2024</span></div>
    ...
    <div class="alert-dashboard-div notf-alert-div animated ZoomIn">
        ...
        <div class="fetch-div animated fadeIn">			
            <div class="fetch" id="fetch_system_alert">
                <script> _fetch_system_alert();</script>
            </div>
        </div> 
    ...
    <div class="bottom-btn-div">
        <button class="btn" onclick="_fetch_previous_alerts()"><i class="bi-chevron-left"></i></button>
        <div><span id="view_from">0</span>-<span id="view_to">0</span> of <span id="all_record_count">0</span></div>
        <button class="btn" onclick="_fetch_next_alerts()"><i class="bi-chevron-right"></i></button>
    </div>
