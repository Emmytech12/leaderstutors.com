...
<div class="slide-form-div animated fadeInRight">
    ...
    <div class="container-back-div sb-container" >
        <div class="inner-div">
            ...
            <button class="action-btn" type="button" title="SUBMIT" id="submit_btn" onclick="_update_tutorial_video('<?php echo $ids?>','<?php echo $other_ids?>','<?php echo $other_ids1?>');"> <i class="bi-check"></i> SUBMIT </button>

        </div>
    </div> 
</div>
<script>_get_fetch_each_video_tutorial('<?php echo $other_ids1?>')</script>
<script>_get_fetch_department_class_subject_form('<?php echo $ids?>','<?php echo $other_ids?>')</script>
<?php } ?>
        ...
        <div class="container-back-div sb-container">
            <div class="inner-div">
                ...
                <select id="blog_cat_id" class="text_field selectinput"  title="SELECT STATUS">
                    ...
                    <!-- <script>_get_select_status('blog_cat_id','1,2');</script> -->
                </select> 
...
<?php if ($page=='access_key_validation_info'){ ?>
    <div class="validation-div animated ZoomIn">
        <div class="div-in">
            ...
            <button class="btn" onclick="_logout();">Okay, Log-In</button>
        </div>
    </div>
<?php } ?>
