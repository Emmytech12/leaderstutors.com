...
<script src="<?php echo $website_auto_url?>/js/jquery-v3.6.1.min.js"></script>
<script src="<?php echo $website_auto_url?>/js/scripts.js"></script>   
<script src="<?php echo $website_auto_url?>/js/aos.js"></script>
<script>
	AOS.init({
